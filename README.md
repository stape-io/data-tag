...
It can also add consent state information (`analytics_storage`, `ad_storage`, `ad_personalization` etc.) read from Google Consent State; and common cookie values, such as Meta, TikTok, Snapchat, Linkedin, Pinterest, Awin etc.
