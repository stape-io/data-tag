...

{
  ...
  "description": "Use this tag for sending data to GTM Server Side Container.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "Domain to where the tag will send requests. For example: gtm.example.com",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "Adds to request all data that are in Data Layer"
  },
  {
    "type": "CHECKBOX",
    "name": "add_common",
